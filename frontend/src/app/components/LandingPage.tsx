...
const testimonials = [
  {
    ...
    text: "منصة مُمكّن سهلت علينا إدارة الهاكاثون بالكامل من التسجيل وحتى إعلان النتائج.",
    image: TESTIMONIAL_1,
  },
  {
    name: "محمد القحطاني",
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto items-start">
            ...
            >
              ...
              <div className="relative bg-white/80 backdrop-blur-sm rounded-3xl p-6 shadow-lg border border-gray-100/50 h-full flex flex-col">
                ...
                {/* Description */}
                <p className="text-sm text-gray-600 leading-relaxed">
                  يستطيع المشاركون إنشاء ملف شخصي موحد، تكوين فرق بسهولة، والعمل داخل مساحة عمل تعاونية تساعدهم على تطوير مشاريعهم طوال الهاكاثون.
                </p>
              </div>
            </motion.div>
